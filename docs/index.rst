...
* Perimeter
* CH1 Mean Intensity
* CH1 Median Intensity
* CH1 Floored Mean
* CH1 StdDev Intensity
* CH1 Floored Mean
* CH1 Ring Region Mean Intensity (opt)
* CH1 Ring Region Median Intensity (opt)
* CH2 Mean Intensity
* CH2 Median Intensity
* CH2 Floored Mean
* CH2 StdDev Intensity
* CH2 Floored Mean
* CH2 Ring Region Mean Intensity (opt)
* CH2 Ring Region Median Intensity (opt)
* CH3 Mean Intensity
* CH3 Median Intensity
* CH3 Floored Mean
* CH3 StdDev Intensity
* CH3 Floored Mean
* CH3 Ring Region Mean Intensity (opt)
* CH3 Ring Region Median Intensity (opt)
